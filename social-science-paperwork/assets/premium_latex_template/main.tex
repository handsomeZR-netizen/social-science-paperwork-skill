...
\begin{document}
\maketitle
\input{demo_disclosure.tex}
\input{sections/00_abstract.tex}
\tableofcontents
\newpage
\input{sections/01_introduction.tex}
\input{sections/02_literature_framework.tex}
\input{sections/03_research_questions.tex}
\input{sections/04_methodology.tex}
\input{sections/05_illustrative_findings.tex}
\input{sections/06_discussion.tex}
\input{sections/07_conclusion.tex}
\appendix
\input{appendix/interview_protocol.tex}
\input{appendix/questionnaire_demo.tex}
\input{appendix/codebook_demo.tex}
\end{document}
